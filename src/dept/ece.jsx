  ...
  return (
    <div>
        <center>
            ...
            <p id="PF">Students in the ECE department have the opportunity to learn about the design, analysis, and implementation of electronic circuits, systems, and devices. They may explore topics such as circuit theory, semiconductor devices, digital logic design, computer architecture, wireless communication, embedded systems, robotics, and power distribution.</p>
           </div>
